...
export default function Advertisements() {
  ...
  return (
    <AdminLayout title="Advertisements">
      <div className="ads-dashboard">
          ...
          <div className="stats-grid">
            ...
            <div className="stat-card stat-active">
              ...
              <div className="stat-info">
                ...
                <span className="stat-trend">{((stats.active/stats.total)*100).toFixed(0)}% of total</span>
              </div>
              <div className="stat-bg-icon">
                <i className="bi bi-check-circle"></i>
              </div>
        ...
        <div className="controls-bar">
          ...
          <div className="controls-right">
            ...
            <button className="btn-create-campaign" onClick={() => router.push('/admin/advertisements/create')}>
        ...
        {filteredAds.length > 0 ? (
                  ...
                  {ad.image_url && (
                    <div className="ad-image-wrapper">
                      ...
                      <div className="ad-overlay">
                        <button className="quick-view" onClick={() => router.push(`/admin/advertisements/${ad.ad_id}`)}>
                  ...
                  <div className="ad-content">
                    ...
                    <div className="ad-footer">
                      ...
                      <div className="ad-actions">
                        <button className="action-btn view" onClick={() => router.push(`/admin/advertisements/${ad.ad_id}`)}>
                          <i className="bi bi-eye"></i>
                          <span>View</span>
                        </button>
                        {ad.status === 'PENDING' && (
                        ...
                        {ad.status === 'ACTIVE' && (
                          <button className="action-btn pause" onClick={() => {
                            if (confirm('Pause this campaign?')) {
                              supabase.from('mobile_advertisements').update({ status: 'EXPIRED' }).eq('ad_id', ad.ad_id).then(() => fetchAds())
                            }
                          }}>
          ...
          <div className="empty-state">
            ...
            <button className="btn-create-first" onClick={() => router.push('/admin/advertisements/create')}>
              <i className="bi bi-plus-circle"></i>
      ...
      {/* Packages Modal - Enhanced Design */}
                ...
                {packages.map((pkg) => (
                  <div key={pkg.package_id} className="package-card-modern">
                    ...
                    <div className="package-actions">
                      ...
                      <button className="delete-package" onClick={() => {
                        if (confirm('Delete this package?')) {
                          supabase.from('subscription_packages').delete().eq('package_id', pkg.package_id).then(() => fetchPackages())
                        }
                      }}>
              ...
              <div className="analytics-grid">
                <div className="analytics-card">
                  ...
                  <div className="analytics-data">
                    ...
                    <span className="analytics-trend">+15.3% vs last month</span>
                  </div>
                </div>
                <div className="analytics-card">
                  <div className="analytics-icon">
                  ...
                  <div className="analytics-data">
                    ...
                    <h2>{stats.ctr}%</h2>
                    <span className="analytics-trend">+2.1% vs last month</span>
                  </div>
                </div>
                <div className="analytics-card">
                  <div className="analytics-icon">
                  ...
                  <div className="analytics-data">
                    ...
                    <span className="analytics-trend">+23% vs last month</span>
                  </div>
                </div>
                <div className="analytics-card">
                  <div className="analytics-icon">
