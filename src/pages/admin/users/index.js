...
export default function UserManagement() {
  ...
  const getRoleBadge = (roleName) => {
    const badges = {
      'SUPER_ADMIN': { class: 'badge-super-admin', icon: 'bi-star-fill', text: 'Super Admin' },
      'CONTENT_ADMIN': { class: 'badge-content-admin', icon: 'bi-file-post', text: 'Content Admin' },
      'SECURITY_ADMIN': { class: 'badge-security-admin', icon: 'bi-shield-lock', text: 'Security Admin' },
      'SUPPORT_ADMIN': { class: 'badge-support-admin', icon: 'bi-headset', text: 'Support Admin' }
    }
    const badge = badges[roleName] || { class: 'badge-default', icon: 'bi-person', text: roleName || 'No Role' }
    return (
                      ...
                      <div className="empty-state">
                        ...
                        <p>
                          {searchTerm || selectedRole !== 'all' || selectedStatus !== 'all' 
                            ? 'No matching users found. Try adjusting your filters.'
